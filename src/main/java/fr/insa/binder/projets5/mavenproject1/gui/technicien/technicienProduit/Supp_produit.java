...
public class Supp_produit extends VerticalLayout{
...
//        this.id = new IntegerField("id produit");
        ...
        this.id = menu_bar.addItem("Selctionner l'identifiant de la produit à supprimer");
        ...
        ComponentEventListener<ClickEvent<MenuItem>> listener = e ->
                {
            try {
                produit.supProduit((Connection) VaadinSession.getCurrent().getAttribute("conn"), Integer.valueOf(e.getSource().getText()));
            } catch (SQLException ex) {
                Notification.show("Problème BdD : s");
            }
        ...
        this.add(new H3("Supprimer produit"));
        this.add(menu_bar);
        }
    }
