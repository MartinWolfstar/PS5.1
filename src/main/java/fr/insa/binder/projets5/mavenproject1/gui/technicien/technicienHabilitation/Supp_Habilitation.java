...
import fr.insa.binder.projets5.mavenproject1.gui.technicien.technicienType.*;
...
public class Supp_Habilitation extends VerticalLayout{
    
    private MenuBar menu_bar;
    private MenuItem id;
    
    public Supp_Habilitation(){
